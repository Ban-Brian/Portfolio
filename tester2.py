...
REQUIRED_DEFNS = [
                    'discountEligibility', 'assignAccess', 'prioritizeTreatment', 'defineBillCategory', 'calculateBill'
                 ]
...
############################################################################
    def test_discountEligibility_1(self):
        self.assertEqual(discountEligibility(30,False), "No Discount")
    
    def test_discountEligibility_2(self):
        self.assertEqual(discountEligibility(66, True), "Senior Discount")

    def test_discountEligibility_3(self):
        self.assertEqual(discountEligibility(65, True), "Membership Discount")

    def test_discountEligibility_4(self):
        self.assertEqual(discountEligibility(10, True), "Child Discount")

    def test_discountEligibility_5(self):
        self.assertEqual(discountEligibility(51, True), "Membership Discount")

    def test_discountEligibility_6(self):
        self.assertEqual(discountEligibility(12, False), "Child Discount")

    def test_discountEligibility_7(self):
        self.assertEqual(discountEligibility(70, False), "Senior Discount")
    
    def test_discountEligibility_8(self):
        self.assertEqual(discountEligibility(14, False), "No Discount")


############################################################################
    def test_assignAccess_1(self):
        self.assertEqual(assignAccess (True, False, True, "General"), "Temporary Access")
    
    def test_assignAccess_2(self):
        self.assertEqual(assignAccess (True, True, True, "ER"), "Full Access")
    
    def test_assignAccess_3(self):
        self.assertEqual(assignAccess (False, True, True, "ICU"), "Emergency Access")
    
    def test_assignAccess_4(self):
        self.assertEqual(assignAccess (False, False, False, "ER"), "Emergency Access")
    
    def test_assignAccess_5(self):
        self.assertEqual(assignAccess (False, True, False, "ICU"), "Visitor Access")
    
    def test_assignAccess_6(self):
        self.assertEqual(assignAccess (False, False, False, "General"), "No Access")
    
    def test_assignAccess_7(self):
        self.assertEqual(assignAccess (False, True, False, "ER"), "Emergency Access" )
    
    def test_assignAccess_8(self):
        self.assertEqual(assignAccess (False, False, True, "General"), "Emergency Access" )           

    
###########################################################################

    def test_prioritizeTreatment_1(self):
        self.assertEqual(prioritizeTreatment(4, 18, False, False), "Medium Priority")
    
    def test_prioritizeTreatment_2(self):
        self.assertEqual(prioritizeTreatment(2, 2, True,  False), "Medium Priority")
    
    def test_prioritizeTreatment_3(self):
        self.assertEqual(prioritizeTreatment(3, 2, False,  False), "Low Priority")
    
    def test_prioritizeTreatment_4(self):
        self.assertEqual(prioritizeTreatment(6, 65, False,  False), "High Priority")
    
    def test_prioritizeTreatment_5(self):
        self.assertEqual(prioritizeTreatment(9, 4, True,  False), "Critical Priority")
    
    def test_prioritizeTreatment_6(self):
        self.assertEqual(prioritizeTreatment(2 , 24, False,  True), "High Priority")
    
    def test_prioritizeTreatment_7(self):
        self.assertEqual(prioritizeTreatment(3 , 30, True,  False), "Low Priority")
    
    def test_prioritizeTreatment_8(self):
        self.assertEqual(prioritizeTreatment(5 , 70, True,  False), "Medium Priority")
    
    def test_prioritizeTreatment_9(self):
        self.assertEqual(prioritizeTreatment(1 , 10, False,  False), "Low Priority")
        
    ############################################################################

    def test_defineBillCategory_1(self):
        self.assertEqual(defineBillCategory(25, True, 70000, False, False), "High Co-Pay")
    
    def test_defineBillCategory_2(self):
        self.assertEqual(defineBillCategory(30, True, 20000, False, True), "Minimal Co-Pay")
    
    def test_defineBillCategory_3(self):
        self.assertEqual(defineBillCategory(67, True, 30000, False, True), "Reduced Standard Co-Pay")
    
    def test_defineBillCategory_4(self):
        self.assertEqual(defineBillCategory(56, True, 25000, True, False), "Minimal Co-Pay")
    
    def test_defineBillCategory_5(self):
        self.assertEqual(defineBillCategory(56, False, 20000, True, False), "Government Assistance Program")
    
    def test_defineBillCategory_6(self):
        self.assertEqual(defineBillCategory(14, False, 1000, False, False), "Government Covered")
    
    def test_defineBillCategory_7(self):
        self.assertEqual(defineBillCategory(26, False, 20000, False, False), "Full Payment Required")
    
    def test_defineBillCategory_8(self):
        self.assertEqual(defineBillCategory(20, True, 50000, False, False), "Standard Co-Pay")
    
    def test_defineBillCategory_9(self):
        self.assertEqual(defineBillCategory(20, False, 18000, False, False), "Subsidized Payment Plan")
    
    def test_defineBillCategory_10(self):
        self.assertEqual(defineBillCategory(22, True, 18000, False, False), "Low Co-Pay")

    ############################################################################
    def test_calculateBill_1(self):
        self.assertEqual(calculateBill(2, 'general', 'x-ray'), 400.0)
    
    def test_calculateBill_2(self):
        self.assertEqual(calculateBill(3, 'private', 'lab'), 2400.0)
    
    def test_calculateBill_3(self):
        self.assertEqual(calculateBill(11, 'semi-private', 'lab'), 3760.0)
    
    def test_calculateBill_4(self):
        self.assertEqual(calculateBill(15, 'general', 'lab'), 2640.0)
    
    def test_calculateBill_5(self):
        self.assertEqual(calculateBill(12, 'private', 'surgery'), 7520.0)
    
    def test_calculateBill_6(self):
        self.assertEqual(calculateBill(4, 'semi-private', 'lab'), 1900.0)
    
    def test_calculateBill_7(self):
        self.assertEqual(calculateBill(5, 'semi-private', 'surgery'), 3000.0)
    
    def test_calculateBill_8(self):
        self.assertEqual(calculateBill(13, 'general', 'surgery'), 2880.0)
    
    def test_calculateBill_9(self):
        self.assertEqual(calculateBill(1, 'private', 'none'), 700.0)
    
    def test_calculateBill_10(self):
        self.assertEqual(calculateBill(15, 'semi-private', 'lab'), 5040.0)
